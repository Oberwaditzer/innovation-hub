...
const WorkshopBlocker = () => {
   const { timeLeft } = useRecoilValue(timerState);

   const open = timeLeft === 0;
      ...
      <Transition.Root show={open} as={Fragment}>
         ...
         >
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
               ...
               >
                  <div className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-1/3 sm:p-6">
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                           ...
                           <div className="mt-2">
                              <p className="text-sm text-gray-500">
                                 Your time for this module is up. Wait for the
                                 facilitator to continue or adding some
                                 additional time.
                              </p>
                           </div>
                        </div>
