import {
   getModuleReview, getModuleStartTime,
   getModuleUserData,
   getUsersFinished,
...
import { GetTimeLeftModule } from '../../utils/WorkshopTimeHandling';
...
const HandleWorkshopConnect = async ({
   ...
   const timeLeft = currentStep ? await GetTimeLeftModule(workshopId, workshop!.steps[currentStep! - 1].durationSeconds) : 0;
